...
window.InitDemo = async function() {
	try {
		const vertexShader = await loadTextResource("./../sancaiWare/Shaders/shader.vs.glsl");
		const fragmentShader = await loadTextResource("./../sancaiWare/Shaders/shader.fs.glsl");
